On this page we provide auxiliary software to convert scientific networks from [https://aminer.org/](https://aminer.org/), version V14 (previously linked from [https://www.aminer.org/citation](https://www.aminer.org/citation)), into the input format of eventnet. Moreover, we provide an eventnet configuration file and an R script to compute hyperedge statistics and to test various effects in interdependent collaboration and citation networks, see the [tutorial on analyzing the coevolution of collaboration and references to prior work](https://github.com/juergenlerner/eventnet/wiki/Coevolution-of-collaboration-and-references-to-prior-work-(tutorial)). 
